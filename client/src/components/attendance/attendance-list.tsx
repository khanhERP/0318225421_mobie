...
export function AttendanceList({ 
  ...
  const { data: attendanceRecords, isLoading } = useQuery({
    queryKey: useRange 
      ? ['https://edpos-mobile-be.onrender.com/api/attendance', 'range', dateRange?.startDate, dateRange?.endDate]
      : ['https://edpos-mobile-be.onrender.com/api/attendance', selectedDate],
    queryFn: async () => {
      let url = 'https://edpos-mobile-be.onrender.com/api/attendance';
