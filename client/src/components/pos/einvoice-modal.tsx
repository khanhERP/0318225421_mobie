...
export function EInvoiceModal({
  ...
  const completePaymentMutation = useMutation({
    mutationFn: ({
      ...
      return apiRequest("PUT", `https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/orders/${orderId}/status`, {
        status: "paid",
  ...
  const { data: allInvoiceTemplates = [] } = useQuery<any[]>({
    queryKey: ["https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/invoice-templates/active"],
    enabled: isOpen,
  });
  ...
  const handleGetTaxInfo = async () => {
    ...
    try {
      ...
      const response = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/tax-code-lookup", {
        method: "POST",
        headers: {
  ...
  const handlePublishLater = async (event?: React.MouseEvent) => {
    ...
    try {
      ...
      // Lưu hóa đơn vào bảng invoices và invoice_items
      const invoiceResponse = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/invoices", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleConfirm = async (event?: React.MouseEvent) => {
    ...
    // Call the proxy API
    const response = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/einvoice/publish", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (result.success) {
      ...
      try {
        ...
        const saveResponse = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/orders", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      try {
        const transactionResponse = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/transactions", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
