...
export default function InventoryPage({ onLogout }: InventoryPageProps) {
  ...
  const updateStockMutation = useMutation({
    mutationFn: async (data: StockUpdateForm) => {
      ...
      const response = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/inventory/update-stock", {
        method: "POST",
        headers: {
  ...
  const updateProductTrackInventoryMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(`https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/products/${id}/track-inventory`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteProductMutation = useMutation({
    mutationFn: async (productId: number) => {
      const response = await fetch(`https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/products/${productId}`, {
        method: "DELETE",
      });
      if (!response.ok) {
  ...
  const cleanupMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch("https://09978332-5dc6-4a9a-8375-fec123be89da-00-1qhtnuziydfl4.pike.replit.dev/products/cleanup/inactive", {
        method: "DELETE",
      });
      if (!response.ok) {
