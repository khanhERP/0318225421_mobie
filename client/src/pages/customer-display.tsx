  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        ...
        // Fetch store info
        const storeResponse = await fetch('https://edpos-mobile-be.onrender.com/api/store-settings');
        if (storeResponse.ok) {
        ...
        const cartResponse = await fetch('https://edpos-mobile-be.onrender.com/api/current-cart');
        if (cartResponse.ok) {
